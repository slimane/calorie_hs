...
main = do
    ...
    let total = show $ foldl1 nAdd [breakFirst, lunch1, lunch2, dinner, dinner2]
    writeFile "/Users/theatrical/learning_haskell/calorie_hs/daily_data/20140409.txt" total
